...
image: "/images/publications/KGMM.png"
imageCaption: "Overview of our KG-driven MM editor in an edu-metaverse setting. (a) Players collaborating on an MM. (b) Root node and interaction ray between the controller and a target node. (c) Semitransparent dummy nodes for recommendations. (d)–(g) UI features: the text editor, color picker, voice-to-text, and shape
